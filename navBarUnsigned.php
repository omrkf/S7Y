...
<body>
  ...
  <div class="sticky-top">
    <nav class="navbar navbar-expand-lg navbar-dark-bg-dark">
      <a class="navbar-brand" href="HOME.php"><img src="img/s7y-logo-light.png" alt="s7y-logo"
          id="navbar-brand-edit"></a>
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link-home  hoooover" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
        ...
        <nav class="cd-main-nav js-main-nav">
          <ul class="cd-main-nav__list js-signin-modal-trigger">
            ...
            <li><a class="cd-main-nav__item cd-main-nav__item--signup hoooover " href="signin.php" data-signin="login" id="signnn">سجل
                دخولك</a></li>
            <li><a class="cd-main-nav__item cd-main-nav__item--signup hoooover" href="signup.php" data-signin="signup"
                id="signnn">اشترك</a></li>
          </ul>
        </nav>
        <hr>
      </div>
